...
class SwingWorkerFrame extends JFrame
{
	...
	/**
	 Reads a file asynchronously, updating the UI during the 
	 ing process.
...
{
	/**
	 Place your task in this method. Be sure to call doUpdate(), 
	 update(), to show the
	...
	/**
	 Override this method for UI operations after each unit of work.
	 */
	public void update()
	{
	}
	...
	/**
	 Override this method for UI operations after work is 
	 completed.
	 */
	public void finish()
	{
	...
	/**
	 Call this method from work() to show the update after each unit 
	 of work.
	 */
